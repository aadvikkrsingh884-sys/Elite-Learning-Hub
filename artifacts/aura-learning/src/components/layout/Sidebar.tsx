...
export function Sidebar() {
  ...
  return (
    // hidden on mobile — users navigate via BottomNav on small screens
    <aside className="hidden md:flex w-[240px] flex-shrink-0 border-r border-sidebar-border bg-sidebar dark:bg-sidebar/95 flex-col h-full transition-all duration-300 dark:border-r-primary/30 z-10 dark:backdrop-blur-xl">
      {/* Brand */}
      <div className="p-6">
      ...
      {/* Nav items */}
      <nav className="flex-1 px-4 space-y-0.5 overflow-y-auto pb-4" aria-label="Main navigation">
        {NAV_ITEMS.map((item) => {
      ...
      {/* Bottom actions */}
      <div className="p-4 border-t border-sidebar-border dark:border-primary/20 space-y-1">
